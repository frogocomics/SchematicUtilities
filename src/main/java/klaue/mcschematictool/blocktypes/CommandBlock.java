...
public class CommandBlock extends Block {
     ...
     *
     * @param command
     * @param signalStrength the strength of the analog signal output by redstone comparators
    ...
    /**
     * gets the signal strength (the strength of the analog signal output by redstone comparators
     * attached to this command block)
     *
    ...
    /**
     * sets the signal strength (the strength of the analog signal output by redstone comparators
     * attached to this command block)
     *

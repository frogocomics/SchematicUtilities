...
public class Rail extends DirectionalBlock {
     ...
     * @param direction the direction (N, W for flat rails, N, E, S, W for ascending rails, NE, SE,
     *                  SW, NW for corners)
     */
        ...
        if (this.railType == RailType.FLAT) {
            switch (direction) {
                ...
                case W:
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("illegal direction for flat rails: " + direction);
            }
            ...
            switch (direction) {
                ...
                case NW:
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("illegal direction for corner rails: " + direction);
            }
            ...
            switch (direction) {
                ...
                case W:
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("illegal direction for ascending rails: " + direction);
            }
            this.direction = direction;
        }
    }
    ...
    public enum RailType {
         ...
         */CORNER,
        /**
         * A flat rail that is ascending to one site
         */ASCENDING;

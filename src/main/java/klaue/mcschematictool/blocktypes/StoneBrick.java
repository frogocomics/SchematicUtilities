    ...
    public void setData(byte data) {
        switch (data) {
            case 0:
                ...
                break;
            case 1:
                this.brickType = BrickType.MOSSY;
                break;
            case 2:
                this.brickType = BrickType.CRACKED;
                break;
            case 3:
                this.brickType = BrickType.CIRCLE;
                break;
            default:
                throw new IllegalArgumentException("illegal brick type value: " + this.data);
        }
        this.data = data;
    }

...
public class Stair extends DirectionalBlock {
    ...
    public static StairType getStairTypeById(short id) {
        switch (id) {
            case 53:
                return StairType.OAKWOOD;
            case 67:
                return StairType.COBBLESTONE;
            case 108:
                return StairType.BRICK;
            case 109:
                return StairType.STONEBRICK;
            case 114:
                return StairType.NETHERBRICK;
            case 128:
                return StairType.SANDSTONE;
            case 134:
                return StairType.SPRUCEWOOD;
            case 135:
                return StairType.BIRCHWOOD;
            case 136:
                return StairType.JUNGLEWOOD;
            case 156:
                return StairType.QUARTZ;
            default:
                throw new IllegalArgumentException("illegal id for stairs: " + id);
        }
    }
    ...
    public void setData(byte data) {
        ...
        switch (directionalData) {
            ...
            case 3:
                ...
                break;
            default:
                throw new IllegalArgumentException("illegal directional state for stairs: " + data);
        }
    ...
    public synchronized BufferedImage getImage(double zoom) {
        ...
        switch (this.stairType) {
            case COBBLESTONE:
                img = ImageProvider.getImageByBlockOrItemID((short) 4);
                break;
            case OAKWOOD:
                img = ImageProvider.getImageByBlockOrItemID((short) 5);
                break;
            case BRICK:
                img = ImageProvider.getImageByBlockOrItemID((short) 45);
                break;
            case STONEBRICK:
                img = ImageProvider.getImageByBlockOrItemID((short) 98);
                break;
            case NETHERBRICK:
                img = ImageProvider.getImageByBlockOrItemID((short) 112);
                break;
            case SANDSTONE:
                img = ImageProvider.getImageByBlockOrItemID((short) 24);
                break;
            case SPRUCEWOOD:
                img = ImageProvider.getImageByBlockOrItemID((short) 5, (byte) 1);
                break;
            case BIRCHWOOD:
                img = ImageProvider.getImageByBlockOrItemID((short) 5, (byte) 2);
                break;
            case JUNGLEWOOD:
                img = ImageProvider.getImageByBlockOrItemID((short) 5, (byte) 3);
                break;
            case QUARTZ:
                img = ImageProvider.getImageByBlockOrItemID((short) 155, (byte) 0);
                break;
        }
        ...
        if (this.isUpsideDown) {
            switch (this.direction) {
                ...
                case E:
                    g.clearRect(0, 8, 8, 8);
                    break; // cut off lower left corner
                case S:
                case W:
                    g.clearRect(8, 8, 8, 8);
                    break; // cut off lower right corner
                default:
                    // should never happen
                    throw new AssertionError(this.direction);
            }
            ...
            switch (this.direction) {
                ...
                case E:
                    g.clearRect(0, 0, 8, 8);
                    break; // cut off upper left corner
                case S:
                case W:
                    g.clearRect(8, 0, 8, 8);
                    break; // cut off upper right corner
                default:
                    // should never happen
                    throw new AssertionError(this.direction);
            }
    ...
    public enum StairType {
        ...
        SANDSTONE,
        /**
         * A wooden stair (spruce)
         */
        SPRUCEWOOD,
        /**
         * A wooden stair (birch)
         */
        BIRCHWOOD,
        /**
         * A wooden stair (jungle)
         */
        JUNGLEWOOD,
        /**
         * Quartz stairs

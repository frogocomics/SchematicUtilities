...
//	}
    ...
    public void setData(byte data) {
        ...
        switch (typeData) {
            case 0:
                this.leafType = TreeType.OAK;
                break;
            case 1:
                this.leafType = TreeType.SPRUCE;
                break;
            case 2:
                this.leafType = TreeType.BIRCH;
                break;
            case 3:
                this.leafType = TreeType.JUNGLE;
                break;
            default:
                throw new IllegalArgumentException("illegal tree type: " + data);
        }

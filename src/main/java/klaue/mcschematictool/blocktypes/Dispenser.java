...
public class Dispenser extends DirectionalBlock {
    ...
    /**
     * Initializes the dispenser. The new dispenser will contain exactly 9 items, some or all of
     * which may be zero (empty)
     *
    ...
    public void setDirection(Direction direction) {
        switch (direction) {
            ...
            case UP:
                ...
                break;
            default:
                throw new IllegalArgumentException("Dispensers do not support the direction " + direction);
        }

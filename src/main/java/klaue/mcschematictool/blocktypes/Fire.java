...
public class Fire extends Block {
    ...
    /**
     * Get the strength of the fire. Strength 0 is a newly set fire, strength 15 (0xF) is an
     * "eternal" fire which receives no
    ...
    /**
     * Set the strength of the fire. Strength 0 is a newly set fire, strength 15 (0xF) is an
     * "eternal" fire which receives no
     * block updates ingame
     *

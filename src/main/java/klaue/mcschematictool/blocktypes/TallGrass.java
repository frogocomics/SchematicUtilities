...
public class TallGrass extends Block {
    ...
    public void setData(byte data) {
        switch (data) {
            case 0:
                this.grassType = GrassType.DEAD_SHRUB;
                break;
            case 1:
                this.grassType = GrassType.TALL_GRASS;
                break;
            case 2:
                this.grassType = GrassType.FERN;
                break;
            default:
                throw new IllegalArgumentException("illegal grass type: " + this.data);
        }
        this.data = data;
    }

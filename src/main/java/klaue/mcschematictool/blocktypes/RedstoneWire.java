...
public class RedstoneWire extends Block {
    ...
    /**
     * Get the strength of the wire. Strength 0 is a non-powered one, strength 15 (0xF) is a wire
     * right next to a power source
     *
     * @return the strength
     */
    ...
    /**
     * Set the strength of the wire. Strength 0 is a non-powered one, strength 15 (0xF) is a wire
     * right next to a power source
     *
    ...
    /**
     * Sets the type of the wire. Since the direction of a redstone wire is not saved into the block
     * data,

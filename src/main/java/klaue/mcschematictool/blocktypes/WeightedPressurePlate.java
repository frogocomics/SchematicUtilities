...
public class WeightedPressurePlate extends Block {
     ...
     *
     * @param weightedPlateType the type of plate
     * @param isPressed         true if this weighted pressure plate is pressed (should not be set
     *                          manually)
     */
    ...
    public void setData(byte data) {
        if (data != 0 && data != 1) {
            throw new IllegalArgumentException("illegal data for weighted pressure plates: " + data);
        }
        this.data = data;

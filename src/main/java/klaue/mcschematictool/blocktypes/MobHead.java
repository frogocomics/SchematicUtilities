...
public class MobHead extends DirectionalBlock {
    ...
    /**
     * Constructor for use in ShematicReader, parameters are values from the tile entity, see
     ...
     * @param data      the blocks' normal data value, 1-5, determining if the head is free standing
     *                  and if not, to which wall it's attached
     */
     ...
     * @param isWallMounted true if this head is on a wall (only valid directions in this case: N,
     *                      E, S, W)
     */
    ...
    public void setHeadTypeByTileEntityValue(byte headType) {
        switch (headType) {
            case 0:
                this.headType = HeadType.SKELETON;
                break;
            case 1:
                this.headType = HeadType.WITHERSKELETON;
                break;
            case 2:
                this.headType = HeadType.ZOMBIE;
                break;
            case 3:
                this.headType = HeadType.HUMAN;
                break;
            case 4:
                this.headType = HeadType.CREEPER;
                break;
            default:
                throw new IllegalArgumentException("Illegal head type: " + headType);
        }
    }
    ...
    public byte getHeadTypeForTileEntities() {
        switch (this.headType) {
            ...
            case CREEPER:
            default:
                return 4; // to make eclipse happy
        }
    }
     ...
     *
     * @param direction direction, 0-15. If this head is wall mounted, only directions N, E, S, W
     *                  are legal
     */
    public void setDirectionByTileEntityValue(byte direction) {
        ...
        switch (direction) {
            ...
            case 15:
                ...
                break;
            default:
                throw new IllegalArgumentException("illegal directional state: " + direction);
        }
    ...
    public void setDirection(Direction direction) {
        ...
        if (this.isWallMounted) {
            ...
            switch (direction) {
                ...
                default:
                    this.data = 5;
                    break; // making eclipse a happy puppy
            }
        } else {
        ...
        if (data == 1) {
            ...
            switch (data) {
                ...
                case 5:
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("Illegal data value for heads: " + data);
            }
    ...
    /**
     * Sets if this mob head is wall mounted or free standing. Warning: will throw exception if
    ...
    public void turn(boolean CW) {
        if (this.isWallMounted) {
            ...
            switch (this.direction) {
                case N:
                    newDir = CW ? Direction.E : Direction.W;
                    break;
                case E:
                    newDir = CW ? Direction.S : Direction.N;
                    break;
                case S:
                    newDir = CW ? Direction.W : Direction.E;
                    break;
                case W:
                    newDir = CW ? Direction.N : Direction.S;
                    break;
                default:
                    // should never happen
            ...
            switch (this.direction) {
                case N:
                    ...
                    break;
                case NNE:
                    this.direction = CW ? Direction.ESE : Direction.WNW;
                    break;
                case NE:
                    this.direction = CW ? Direction.SE : Direction.NW;
                    break;
                case ENE:
                    this.direction = CW ? Direction.SSE : Direction.NNW;
                    break;
                case E:
                    this.direction = CW ? Direction.S : Direction.N;
                    break;
                case ESE:
                    this.direction = CW ? Direction.SSW : Direction.NNE;
                    break;
                case SE:
                    this.direction = CW ? Direction.SW : Direction.NE;
                    break;
                case SSE:
                    this.direction = CW ? Direction.WSW : Direction.ENE;
                    break;
                case S:
                    this.direction = CW ? Direction.W : Direction.E;
                    break;
                case SSW:
                    this.direction = CW ? Direction.WNW : Direction.ESE;
                    break;
                case SW:
                    this.direction = CW ? Direction.NW : Direction.SE;
                    break;
                case WSW:
                    this.direction = CW ? Direction.NNW : Direction.SSE;
                    break;
                case W:
                    this.direction = CW ? Direction.N : Direction.S;
                    break;
                case WNW:
                    this.direction = CW ? Direction.NNE : Direction.SSW;
                    break;
                case NW:
                    this.direction = CW ? Direction.NE : Direction.SW;
                    break;
                case NNW:
                    this.direction = CW ? Direction.ENE : Direction.WSW;
                    break;
                default:
                    // should never happen
                    throw new AssertionError(this.direction);
    ...
    public synchronized BufferedImage getImage(double zoom) {
        ...
        if (this.isWallMounted) {
            ...
            switch (this.direction) {
                case E:
                    dirForCache = Direction.W;
                    break;
                case S:
                    dirForCache = Direction.N;
                    break;
                case W:
                    dirForCache = Direction.E;
                    break;
                case N:
                default:
                    dirForCache = Direction.S;
                    break;
            }
        }
        ...
        switch (this.headType) {
            case SKELETON:
                img = ImageProvider.getItemImage("skull_skeleton");
                break;
            case WITHERSKELETON:
                img = ImageProvider.getItemImage("skull_wither");
                break;
            case ZOMBIE:
                img = ImageProvider.getItemImage("skull_zombie");
                break;
            case CREEPER:
                img = ImageProvider.getItemImage("skull_creeper");
                break;
            case HUMAN:
                img = ImageProvider.getItemImage("skull_char");
                break;
        }
    ...
    public enum HeadType {
         ...
         * wither
         */WITHERSKELETON("Wither skeleton skull"), /**
         * zombie
         */ZOMBIE("Zombie head"),
        /**
         * human

...
public class Sandstone extends Block {
    ...
    public void setData(byte data) {
        switch (data) {
            case 0:
                this.sandstoneType = SandstoneType.NORMAL;
                break;
            case 1:
                this.sandstoneType = SandstoneType.CHISELED;
                break;
            case 2:
                this.sandstoneType = SandstoneType.SMOOTH;
                break;
            default:
                throw new IllegalArgumentException("illegal data value for sandstones: " + data);
        }
        this.data = data;
    }

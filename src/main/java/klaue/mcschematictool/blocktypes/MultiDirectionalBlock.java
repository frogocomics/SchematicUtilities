...
public abstract class MultiDirectionalBlock extends Block {
    ...
    /**
     * Adds red arrows to the image, pointing in all the given directions. If one direction is not
     * in the 45° range, two arrows
    ...
    /**
     * returns the directions this block faces or the directions of the blocks this block is
     * attached to, depending on the type of block
     *
    ...
    /**
     * sets the directions this block faces or the directions of the block this block is attached

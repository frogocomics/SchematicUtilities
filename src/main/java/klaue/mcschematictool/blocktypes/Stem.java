...
public class Stem extends Block {
    ...
    /**
     * Get the growth value of the stem. Growth 0 is a newly planted one, growth 7 is one that will
     * spawn a melon/pumpkin
     *
     * @return the growth
     */
    ...
    /**
     * Set the growth value of the stem. Strength 0 is a newly planted one, strength 7 is one that
     * will spawn a melon/pumpkin
     *

...
public class Lava extends Block {
    ...
    public Lava(short id, byte data) {
        super(id, data);
        if (id != 10 && id != 11) {
            throw new IllegalArgumentException("invalid id for lava: " + id);
        }
     ...
     * @param level        The level. Level 0 is a full block, 6 a nearly empty one. Valid values
     *                     are 0, 2, 4 and 6
     */
    ...
    /**
     * Get the level value of the lava. Level 0 is a full block, 6 a nearly empty one. Valid values
     * are 0, 2, 4 and 6
     *
     * @return the level
     */
    ...
    /**
     * Set the level value of the lava. Level 0 is a full block, 6 a nearly empty one. Valid values
     * are 0, 2, 4 and 6
     *

...
public abstract class DirectionalBlock extends Block {
    ...
    /**
     * Adds a red arrow to the image, pointing in the given direction. If the direction is not in
     * the 45° range, two arrows
     * will be used to show the direction, for example, NNW will have an arrow pointing to north and
     * one pointing to NW.
    ...
    /**
     * returns the direction this block faces or the direction of the block this block is attached
     * to, depending on the type of block
     *
    ...
    /**
     * sets the direction this block faces or the direction of the block this block is attached to,

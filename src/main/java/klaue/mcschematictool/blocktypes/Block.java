...
public class Block {
    ...
    protected static HashMap<Short, BufferedImage> imageCache = new HashMap<>();
    ...
    /**
     * Get the additional block data. It's generally a better idea to figure out the block type and
     * using the getters
    ...
    /**
     * Sets the raw data value. It's generally a better idea to figure out the block type and using
     * the setters
     ...
     * Warning: Block caches images by ID and ID only. If the block changes looks by data value,
     * make a subclass
     *
    ...
    public synchronized BufferedImage getImage(double zoom) {
        ...
        if (Block.zoomCache != zoom) {
            ...
            img = Block.imageCache.get(this.id);
            if (img != null) {
                return img;
            }
        }
        ...
        // save image to cache
        Block.imageCache.put(this.id, img);
     ...
     *
     * @return the type. Type normal is a non-special, non-directional normal block without state
     * like dirt
     */
    public Type getType() {
        return this.type;
    ...
    /**
     * Block types. Normal is a non-special, non-directional block without a state, like dirt.
     *
     * @author klaue
     */
    public enum Type {
        /**
         * Normal blocks like dirt
         */NORMAL,
        /**
         ...
         */WATER,
        /**
         * Flowing and still lava
         */LAVA,
        /**
         * Wool of all colors
         */WOOL,
        /**
         * Straight rails and corners
         */RAIL,
        /**
         * Straight powered rails
         */POWERED_RAIL,
        /**
         * Straight detector rails
         */DETECTOR_RAIL,
        /**
         * Burning and non-burning redstone torches
         */REDSTONE_TORCH,
        /**
         * Stone, wood, brick and stone brick stairs
         */STAIR,
        /**
         * Both wooden and iron doors
         */DOOR,
        /**
         * Both wooden and stone pressure plates
         */PRESSUREPLATE,
        /**
         * Both light and heavy weighted pressure plates
         */WEIGHTEDPRESSUREPLATE,
        /**
         * Both slabs and double slabs of all types (stone)
         */STONESLAB,
        /**
         * Both slabs and double slabs of all types (wood)
         */WOODENSLAB,
        /**
         * Both standing and wall signs
         */SIGN,
        /**
         * Stone bricks incl. mossy and cracked
         */STONEBRICK,
        /**
         * Red and brown huge mushrooms
         */HUGEMUSHROOM,
        /**
         * Both sticky and normal pistons
         */PISTON,
        /**
         * Both sticky and normal pistons ext.
         */PISTONEXTENSION,
        /**
         * Dispensers
         */DISPENSER, /**

...
public class Jukebox extends Block {
    ...
    public void setData(byte data) {
        switch (data) {
            case 0:
                this.discType = DiscType.NONE;
                break;
            case 1:
                this.discType = DiscType.GOLD;
                break;
            case 2:
                this.discType = DiscType.GREEN;
                break;
            case 3:
                this.discType = DiscType.ORANGE;
                break;
            case 4:
                this.discType = DiscType.RED;
                break;
            case 5:
                this.discType = DiscType.LIMEGREEN;
                break;
            case 6:
                this.discType = DiscType.PURPLE;
                break;
            case 7:
                this.discType = DiscType.VIOLET;
                break;
            case 8:
                this.discType = DiscType.BLACK;
                break;
            case 9:
                this.discType = DiscType.WHITE;
                break;
            case 10:
                this.discType = DiscType.SEAGREEN;
                break;
            case 11:
                this.discType = DiscType.BROKEN;
                break;
            default:
                throw new IllegalArgumentException("No such disc type: " + data);
        }
        this.data = data;
    }

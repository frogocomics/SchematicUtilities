...
public class StoneSlab extends Block {
    ...
    public void setData(byte data) {
        if (data > 15) {
            throw new IllegalArgumentException("illegal data value for stone slabs: " + data);
        }
        ...
        switch (typedata) {
            case 0:
                this.slabType = SlabType.STONE;
                break;
            case 1:
                this.slabType = SlabType.SANDSTONE;
                break;
            case 2:
                this.slabType = SlabType.WOOD;
                break;
            case 3:
                this.slabType = SlabType.COBBLESTONE;
                break;
            case 4:
                this.slabType = SlabType.BRICK;
                break;
            case 5:
                this.slabType = SlabType.STONEBRICK;
                break;
            case 6:
                this.slabType = SlabType.NETHERBRICK;
                break;
            case 7:
                this.slabType = SlabType.QUARTZ;
                break;
            default:
                throw new IllegalArgumentException("illegal data value for stone slabs: " + data);
        }
        if (this.isDoubleSlab) {
            switch (data) {
                case 8:
                    this.slabType = SlabType.SMOOTHSTONE;
                    break;
                case 9:
                    this.slabType = SlabType.SMOOTHSANDSTONE;
                    break;
                case 15:
                    this.slabType = SlabType.TILEQUARTZ;
                    break;
            }
        }
        this.data = data;
    ...
    public synchronized BufferedImage getImage(double zoom) {
        ...
        switch (this.slabType) {
            ...
            case SANDSTONE:
                ...
                break;
            case STONE:
                img = ImageProvider.getImage("stoneslab_side");
                break; // stone doubleslab
            case WOOD:
            ...
            case QUARTZ:
                ...
                break;
            case SMOOTHSTONE:
                img = ImageProvider.getImageByBlockOrItemID((short) 1);
                break;
            case SMOOTHSANDSTONE:
                img = ImageProvider.getImageByBlockOrItemID((short) 24, (byte) 2);
                break;
            case TILEQUARTZ:
                img = ImageProvider.getImageByBlockOrItemID((short) 155, (byte) 0);
                break;

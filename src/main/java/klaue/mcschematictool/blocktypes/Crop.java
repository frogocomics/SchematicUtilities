...
public class Crop extends Block {
    ...
    /**
     * Get the growth value of the crops. Growth 0 are newly planted ones, growth 7 are ones that
     * can be harvested
     *
     * @return the growth
     */
    ...
    /**
     * Set the growth value of the crops. Growth 0 are newly planted ones, growth 7 are ones that
     * can be harvested
     *

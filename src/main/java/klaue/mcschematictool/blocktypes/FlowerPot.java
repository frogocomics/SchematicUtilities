...
public class FlowerPot extends Block {
    ...
    public void setData(byte data) {
        switch (data) {
            case 0:
                this.pottedPlant = PottedPlantType.NONE;
                break;
            case 1:
                this.pottedPlant = PottedPlantType.ROSE;
                break;
            case 2:
                this.pottedPlant = PottedPlantType.DANDELION;
                break;
            case 3:
                this.pottedPlant = PottedPlantType.OAKSAPLING;
                break;
            case 4:
                this.pottedPlant = PottedPlantType.SPRUCESAPLING;
                break;
            case 5:
                this.pottedPlant = PottedPlantType.BIRCHSAPLING;
                break;
            case 6:
                this.pottedPlant = PottedPlantType.JUNGLETREESAPLING;
                break;
            case 7:
                this.pottedPlant = PottedPlantType.REDMUSHROOM;
                break;
            case 8:
                this.pottedPlant = PottedPlantType.BROWNMUSHROOM;
                break;
            case 9:
                this.pottedPlant = PottedPlantType.CACTUS;
                break;
            case 10:
                this.pottedPlant = PottedPlantType.DEADBUSH;
                break;
            case 11:
                this.pottedPlant = PottedPlantType.FERN;
                break;
            default:
                throw new IllegalArgumentException("illegal potted plant value: " + this.data);
        }
        this.data = data;
    }
    ...
    public synchronized BufferedImage getImage(double zoom) {
        ...
        if (this.pottedPlant == PottedPlantType.NONE) {
            ...
            switch (this.pottedPlant) {
                case ROSE:
                    plantImg = ImageProvider.getImage("rose");
                    break;
                case DANDELION:
                    plantImg = ImageProvider.getImage("flower");
                    break;
                case OAKSAPLING:
                    plantImg = ImageProvider.getImage("sapling");
                    break;
                case SPRUCESAPLING:
                    plantImg = ImageProvider.getImage("sapling_spruce");
                    break;
                case BIRCHSAPLING:
                    plantImg = ImageProvider.getImage("sapling_birch");
                    break;
                case JUNGLETREESAPLING:
                    plantImg = ImageProvider.getImage("sapling_jungle");
                    break;
                case REDMUSHROOM:
                    plantImg = ImageProvider.getImage("mushroom_red");
                    break;
                case BROWNMUSHROOM:
                    plantImg = ImageProvider.getImage("mushroom_brown");
                    break;
                case CACTUS:
                    plantImg = ImageProvider.getImage("cactus_side");
                    break;
                case DEADBUSH:
                    plantImg = ImageProvider.getImage("deadbush");
                    break;
                case FERN:
                default:
                    plantImg = ImageProvider.getAdditionalImage("fern");
                    break;
            }
    ...
    public enum PottedPlantType {
        ...
        /**
         * Jungle tree sapling
         */JUNGLETREESAPLING("jungle tree sapling"), /**
         * Red mushroom
        ...
        PottedPlantType(String name) {
            this.name = name;
        }

        @Override
        public String toString() {
            return (this.name == null) ? super.toString().toLowerCase() : this.name;
        }
    }
}

...
public class NetherWart extends DataImageCacheBlock {
    ...
    /**
     * Get the growth value of the nether wart. Growth 0 are newly planted ones, growth 3 are ones
    ...
    /**
     * Set the growth value of the nether wart. Growth 0 are newly planted ones, growth 3 are ones
     * that can be harvested
     *

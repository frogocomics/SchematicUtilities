...
/**
 * A button can have different directions and be off or on
 *
 * @author klaue
 */
public class Button extends DirectionalBlock {
     ...
     * @param isPressed  true if this button is pressed (should not be set manually because the
     *                   button will never depress)
    ...
    /**
     * Set to true to set this button pressed (should not be set manually because the button will
     * never depress)
     *

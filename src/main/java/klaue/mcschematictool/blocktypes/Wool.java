    ...
    public void setData(byte data) {
        switch (data) {
            case 0:
                ...
                break;
            case 1:
                this.color = WoolColor.ORANGE;
                break;
            case 2:
                this.color = WoolColor.MAGENTA;
                break;
            case 3:
                this.color = WoolColor.LIGHTBLUE;
                break;
            case 4:
                this.color = WoolColor.YELLOW;
                break;
            case 5:
                this.color = WoolColor.LIGHTGREEN;
                break;
            case 6:
                this.color = WoolColor.PINK;
                break;
            case 7:
                this.color = WoolColor.GRAY;
                break;
            case 8:
                this.color = WoolColor.LIGHTGRAY;
                break;
            case 9:
                this.color = WoolColor.CYAN;
                break;
            case 10:
                this.color = WoolColor.PURPLE;
                break;
            case 11:
                this.color = WoolColor.BLUE;
                break;
            case 12:
                this.color = WoolColor.BROWN;
                break;
            case 13:
                this.color = WoolColor.DARKGREEN;
                break;
            case 14:
                this.color = WoolColor.RED;
                break;
            case 15:
                this.color = WoolColor.BLACK;
                break;
            default:
                throw new IllegalArgumentException("illegal color value: " + this.data);
        }
        this.data = data;
    }

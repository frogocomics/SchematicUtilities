...
public class Water extends Block {
    ...
    public Water(short id, byte data) {
        super(id, data);
        if (id != 8 && id != 9) {
            throw new IllegalArgumentException("not a valid water id: " + id);
        }
    ...
    /**
     * Get the level value of the water. Level 0 is a full block. Can go up to (or rather, down to)
     * 7.
     *
     * @return the level
     */
    ...
    /**
     * Set the level value of the water. Level 0 is a full block. Can go up to (or rather, down to)
     * 7.
     *

...
public class Chest extends Block {
    ...
    /**
     * Initializes the (untrapped) chest. The new chest will contain exactly 27 items, some or all
     * of which may be zero (empty)
     *
    ...
    /**
     * Initializes the chest. The new chest will contain exactly 27 items, some or all of which may
     * be zero (empty)
     *
     * @param isTrapped true for a trapped chest
     * @param content   The chests content or null for an empty chest
    ...
    public Chest(short id, Item[] content) {
        ...
        switch (id) {
            ...
            case 146:
                ...
                break;
            default:
                throw new IllegalArgumentException("Invalid ID " + id + " for a chest");
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.isTrapped != this.isTrapped) {
            return false;
        }
        return true;
    }

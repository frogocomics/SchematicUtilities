...
public class Sign extends DirectionalBlock {
    ...
    /**
     * Initializes the sign. The new sign will contain exactly 4 lines of text, some or all of which
     * may be empty
     *
     ...
     *
     * @param text       The signs text or null for an emty sign
     * @param isWallSign true if this sign is a wall sign (ID 68), false if it's a freestanding one
     *                   (ID 63)
     * @param data       the direction as a minecraft data value
     */
    ...
    /**
     * Sets the direction member value according to the data tag. See the minecraft data tag
     * description
     */

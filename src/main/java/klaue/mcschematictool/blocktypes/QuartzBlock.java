...
public class QuartzBlock extends DataImageCacheBlock {
    ...
    public void setData(byte data) {
        switch (data) {
            case 0:
                this.quartzType = QuartzType.NORMAL;
                break;
            case 1:
                this.quartzType = QuartzType.CHISELED;
                break;
            case 2:
                this.quartzType = QuartzType.PILLAR_V;
                break;
            case 3:
                this.quartzType = QuartzType.PILLAR_N;
                break;
            case 4:
                this.quartzType = QuartzType.PILLAR_E;
                break;
            default:
                throw new IllegalArgumentException("illegal quartz type value: " + this.data);
        }
        this.data = data;
    }
    ...
    public enum QuartzType {
         ...
         */CHISELED, /**
         * pillar quartz (vertical)
         */PILLAR_V,
        /**
         * pillar quartz (north/south)
         */PILLAR_N, /**
         * pillar quartz (east/west)
         */PILLAR_E
    }
}

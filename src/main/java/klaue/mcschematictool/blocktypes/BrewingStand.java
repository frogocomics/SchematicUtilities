...
public class BrewingStand extends MultiDirectionalBlock {
    ...
    public void setData(byte data) {
        ...
        if ((data & 2) != 0) {
            this.directions.add(Direction.NW);
        }
        if ((data & 4) != 0) {
            this.directions.add(Direction.SW);
        }
    }
            ...
            for (Direction dir : directions) {
                switch (dir) {
                    ...
                    case SW:
                        ...
                        break; // 100
                    default:
                        throw new IllegalArgumentException("illegal direction " + dir + " in direction array " + directions);
                }
            }
        }
    ...
    public void turn(boolean CW) {
        ...
        if (CW) {
            for (Direction dir : this.directions) {
                switch (dir) {
                    case E:
                        newDirections.add(Direction.SW);
                        break;
                    case SW:
                        newDirections.add(Direction.NW);
                        break;
                    case NW:

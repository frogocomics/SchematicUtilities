...
public class SchematicReader {
                            ...
                            if (blockid == 54 || blockid == 146 || blockid == 23 || blockid == 154 || blockid == 158) {
                                ...
                                if (tileEntity == null) {
                                    ...
                                    switch (blockid) {
                                        ...
                                        case 54:
                                            block = new Chest(blockid);
                                            break;
                                        case 23:
                                            block = new Dispenser(null, data[blocknumber]);
                                            break;
                                        case 154:
                                            block = new Hopper(null, data[blocknumber]);
                                            break;
                                        case 158:
                                        default:
                                            block = new Dropper(null, data[blocknumber]);
                                            break;
                                    }
                                } else {
                                    ...
                                    switch (blockid) {
                                        case 146: // trapped chest
                                        case 54:
                                            block = new Chest(blockid, items);
                                            break;
                                        case 23:
                                            block = new Dispenser(items, data[blocknumber]);
                                            break;
                                        case 154:
                                            block = new Hopper(items, data[blocknumber]);
                                            break;
                                        case 158:
                                        default:
                                            block = new Dropper(items, data[blocknumber]);
                                            break;
                                    }
                                }
                            } else if (blockid == 25) {
    ...
    private static void addItemToListFromCompound(Item[] items, CompoundTag itemTag) {
        ...
        if (tag == null || tag instanceof CompoundTag == false) {
            return;
        }

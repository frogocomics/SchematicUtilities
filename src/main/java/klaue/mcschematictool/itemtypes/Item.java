...
public class Item {
    ...
    public static Item getInstance(short id, short data, byte stacksize) {
        switch (id) {
            case 373:
                return new Potion(data, stacksize);
            case 298:
                return new LeatherHelmet(data, stacksize);
            case 299:
                return new LeatherChestplate(data, stacksize);
            case 300:
                return new LeatherLeggings(data, stacksize);
            case 301:
                return new LeatherBoots(data, stacksize);
            default:
                return new Item(id, data, stacksize);
        }
    }
    ...
    /**
     * sets the data value. note that if availlable, you should use the methods of the specific
     * subclass instead
     *
    ...
    /**
     * @return the display name of this item (can be empty, see NameProvider.getNameOfBlockOrItem()
     * for default name)
     */
    ...
    public boolean isColoredItem() {
        if (isLeatherBoots() || isLeatherChestplate() || isLeatherHelmet() || isLeatherLeggins()) {
            return true;
        }
    ...
    public enum Type {
        /**
         * Normal items like wheat
         */NORMAL,
        /**
         * Potions, normal and splash
         */POTION,
        /**
         * colored items
         */COLORED,

...
public class Potion extends Item {
    ...
    /**
     * All the possible names of the potions. Potion with ID 0 (mundane potion) can also be "Water
     * Bottle"
     */
    ...
    /**
     * @param potionName The name of the potion. Must be exact and not include "Splash", or else a
     *                   water bottle/mundane potion is generated.
    ...
    public void setExtDuration(boolean hasExtDuration) {
        if (this.hasExtDuration == hasExtDuration) {
            return;
        }
    ...
    /**
     * @param base true to get the base duration value in seconds, false to get the real one (with
     *             tier and ext. duration)
     * @return the duration
     */

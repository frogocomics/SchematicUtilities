...
/**
 * Colored boots made of leather
 *
 * @author klaue
 */
public class LeatherBoots extends ColoredItem {
    /**
     * Generates new leather boots, color white
     *
     ...
     */
    public LeatherBoots(short data, byte stacksize) {
        this(data, stacksize, new Color(139, 69, 19)); // brown
    }

    /**
     * Generates new leather boots of type id
     *
     * @param data      Item data
     * @param stacksize the number of items in this stack
     * @param color     the color or white if null
     */
    public LeatherBoots(short data, byte stacksize, Color color) {
        super((short) 301, data, stacksize);
        setColor(color);
        this.type = Type.LEATHERBOOTS;
    }
    ...
    public synchronized BufferedImage getImage(double zoom) {
        ...
        BufferedImage overlay = ImageProvider.getItemImage("bootsCloth_overlay");

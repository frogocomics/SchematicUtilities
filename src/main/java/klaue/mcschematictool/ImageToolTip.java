...
/**
 * An implementation of JToolTip that supports images. return an instance of this in the components
...
public class ImageToolTip extends JToolTip {
     ...
     *
     * @param img the image that should be the tooltip. Null will cause this tooltip to act like a
     *            normal one
     */

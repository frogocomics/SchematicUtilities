...
public class NameProvider {
     ...
     * It only provides the name of the block itself, so giving the data value for, for example,
     * rails makes no sense as the rails data
     * contains directional information - if you need this too, get an instance per
     * Block.getInstance() and read that instances toString()
     *
     * @param id   the id of the block
     * @param data the data of the block or -1 if it doesn't matter for the block name (or the
     *             default value like white wool for wool)
    ...
    public static String getNameOfBlockOrItem(short id, byte data) {
        ...
        switch (id) {
            ...
            case 5:    // Wooden Plank
                switch (data) {
                    case 1:
                        return "Wooden Plank (spruce)";        // Pine
                    case 2:
                        return "Wooden Plank (birch)";        // Birch
                    case 3:
                        return "Wooden Plank (jungle)";        // Jungle
                    case 0:
                    default:
                        return "Wooden Plank (oak)";    // Normal (oak)
                }
            case 6:
            ...
            case 8:
            case 9:
                return "Water"; // water and still water
            case 10:
            case 11:
                return "Lava"; // lava and still lava
            case 12:
                return "Sand";
            case 13:
                return "Gravel";
            ...
            case 43:
                ...
                switch (typedata) {
                    case 1:
                        if (data == 9) {
                            return "Smooth Sandstone Doubleslab";
                        }
                    ...
                    case 7:
                        if (data == 15) {
                            return "Tile Quartz Doubleslab";
                        }
                        return "Quartz Doubleslab";
                    case 0:
                        if (data == 8) {
                            return "Smooth Stone Doubleslab";
                        }
            ...
            case 61:
            case 62:
                return "Furnace"; // ids differ for on or off, but we don't care here
            case 63:
            case 68:
                return "Sign";
            case 64:
            ...
            case 125:
                ...
                switch (typedata) {
                    case 1:
                        return "Spruce-Wood Doubleslab";
                    case 2:
                        return "Birch-Wood Doubleslab";
                    case 3:
                        return "Jungle-Wood Doubleslab";
                    case 0:
                    default:
                        return "Oak-Wood Doubleslab";
                }
            case 126:
                ...
                switch (typedata) {
                    case 1:
                        return upper + "Spruce-Wood Slab";
                    case 2:
                        return upper + "Birch-Wood Slab";
                    case 3:
                        return upper + "Jungle-Wood Slab";
                    case 0:
                    default:
                        return upper + "Oak-Wood Slab";
                }
            case 127:
                switch (data >> 2) {
                    case 1:
            ...
            case 143:
                return "Wood Button";
            case 144:
                return "Human head"; // other heads determined trough tile entity
            case 145:
                return "Anvil";
            case 146:
